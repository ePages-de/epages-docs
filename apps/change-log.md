...
* Updated the attribute `scriptUrl` of data type [scriptTag](https://developer.epages.com/apps/data-types.html#scripttag) by adding the possibility to register as a `ServiceWorker`.
