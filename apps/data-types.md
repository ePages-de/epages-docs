...
| productVariationMasterId | string | The unique identifier of the master product of a variation. Null if the product itself is a master or a regular product. |
| productVariationMasterName | string | The name of the master product of a variation. Null if the product is a master or a regular product. |
