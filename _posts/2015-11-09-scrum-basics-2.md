...
To function well they need to work closely together and, at best, also sit in one room.
...
It’s also the Development Team's decision, how many tickets they decide to solve within a sprint.
...
Just in Scrum they can tell themselves, how much time they need to deliver something, which gives them the freedom to achieve the big goal of the Scrum Framework: to deliver quality products.

# Product Owner

{% image blog-scrum2-productowner.jpg 30% left %}{% endimage %}
...
However, they do decide what the team is going to develop next.
They are setting up the Product Backlog and decide the business value of each ticket and with that the ticket order.
That means, the PO is responsible for the Return of Investment (ROI).
They decide if fixing a bug is more important than developing a new feature.
...
As you can see, the Product Owner is a very important and complex role in Scrum and so it’s no wonder that several trainings exist one should participate in before agreeing on this job.

# Scrum Master

{% image blog-scrum2-scrummaster.jpg 30% left %}{% endimage %}
...
The developer is distracted from his actual task and since it was a manager who told them to go work on something else, they usually do it.
Not in Scrum!
...
He is responsible to coach not only the team and the PO on Scrum and agile development topics, but also all other departments in the company that have to interact with the Scrum Teams.
...
The SM would need to talk to them to know, if the Development Team might plan less tickets in the next sprint in order to have more support time.

Two more tasks are left for the Scrum Master to do: facilitating meeting and mediation talks.
...
Combine “protect the team”, “remove impediments”, “push for constant improvement” and “moderate meeting so they have a valuable outcome and end in time” and you can see where the value of this extra employee pushes in.
