...
First it was mainly about refining, enhancing, and adding value to our current core shop software ePages 6, but than it changed to lay out the foundation of our very latest backend architecture ePages BEYOND.
...
Only then, we integrated the new storefront [ePages Now](https://www.epages.com/de/now/) through the [REST API](https://developer.epages.com/apps) and launched the beta phase by the end of last year.
...
Well, shortly before I joined, the company went through a reorganization from a rather waterfall oriented development cycle to an agile approach  {% emoji smile %}, and furthermore, we had not enough developers to fulfil our ambitious product plans.
...
Well yes.
I introduced our [epagesdevs](https://twitter.com/epagesdevs) Twitter channel and pushed for establishing of our developer blog, as I noticed the lack of employer branding in the community.
The teams alternate every month with writing tech stories that are related to their work using markdown, [git](https://git-scm.com/) and do pull requests on [GitHub](https://github.com/) to our [tech writer](https://developer.epages.com/blog/2016/11/30/agile-techwriter.html).
...
In the morning I usually cycle 35 minutes to work.
...
We use Java and [Spring Boot](https://projects.spring.io/spring-boot/) for our new microservices, API and [Elastic Search](https://www.elastic.co/) for the search-driven shop.
