...
Other languages like Elixir (which we're going to talk about in a bit) make it much easier to use functional language features and methods such as *destructuring*, *pattern matching* or *recursion*.
...
What you would have done, is to create a new list with every value from the old one that you see fits.
